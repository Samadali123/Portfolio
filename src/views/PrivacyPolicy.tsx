            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                        At ASG Solutions, your privacy is our priority. This policy outlines our commitment to transparency and data protection.
                    </p>
                ...
                <div className="space-y-8">
                    {sections.map((section, index) => (
                        <motion.div
                            ...
                            className="rounded-4xl p-8 md:p-10 shadow-xl border theme-border-secondary group hover:shadow-2xl transition-all duration-300"
                        >
                ...
                <motion.div
                    ...
                    className="mt-16 p-8 rounded-4xl theme-bg-secondary text-center text-white shadow-2xl"
                >
