...
import { FileText, CheckCircle2, AlertCircle, Gavel, Scale, Globe, Terminal, UserCheck } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      content: "By accessing and using the Nexora Solutions website and services, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using these particular services, you shall be subject to any posted guidelines or rules applicable to such services."
    },
    {
      icon: UserCheck,
    ...
    },
    {
      ...
      content: "All content, software, and AI models provided by Nexora Solutions are the exclusive property of Nexora Solutions or its licensors. Users are granted a limited, non-transferable license to use our services according to the specific service agreement purchased."
    },
    {
      icon: Scale,
      title: "4. Limitation of Liability",
      content: "Nexora Solutions shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or the inability to use our cloud or AI services. We provide our platform on an 'as is' and 'as available' basis without any warranties of any kind."
    },
    {
      icon: Gavel,
      title: "5. Termination",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Please read these terms carefully before using our services. They govern your relationship with Nexora Solutions' platform and infrastructure.
          </p>
        ...
        <div className="space-y-8">
          {sections.map((section, index) => (
            <motion.div
              ...
              className="rounded-[2rem] p-8 md:p-10 shadow-3xl border theme-border-secondary group hover:shadow-2xl transition-all duration-300"
            >
