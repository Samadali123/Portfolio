      ...
      >
        ...
        >
          <div className="relative mb-8">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.div
                className="w-64 h-64 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full filter blur-3xl"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.5, 0.8, 0.5],
                }}
        ...
        >
          <p className="theme-text-muted">
            If you think this is a mistake, <Link to="/contact" className="theme-text-secondary font-bold hover:underline">contact us</Link>.
          </p>
        </motion.div>
      </motion.div>
    </div>
